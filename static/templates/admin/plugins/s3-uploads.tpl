...
<div class="alert alert-warning">
	<p>If you need help, create an <a href="https://github.com/nd-lqj/nodebb-plugin-s3-uploads/issues/">issue on
		Github</a>.</p>
</div>

<input type="text" id="csrf_token" value="{csrf}" style="display:none;">
